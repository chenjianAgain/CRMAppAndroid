package com.zendaimoney.android.athena.im.model;
...
//		this.type = MSGTYPE_IMG ; //SUCCESS;
	...
	public static final Parcelable.Creator<IMMessage> CREATOR = new Parcelable.Creator<IMMessage>() {
		...
		public IMMessage createFromParcel(Parcel source) {
			...
			Log.i(">>>>>>>>IMMSG", "************&&&&&&&&&&&&&&&&--------getType="+message.getType());
			Log.i(">>>>>>>>IMMSG", "************&&&&&&&&&&&&&&&&--------getTime="+message.getTime());
			return message;
		}

		@Override
		public IMMessage[] newArray(int size) {
			Log.i(">>>>>>>>IMMSG", "************&&&&&&&&&&&&&&&&----newArray----size="+size);
