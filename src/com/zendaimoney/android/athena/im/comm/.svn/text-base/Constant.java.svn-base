package com.zendaimoney.android.athena.im.comm;
...
public class Constant {
	...
	public static final String RECONNECT_ACTION = "reconnect.openfire";
...
//	public static final String XMPP_HOST = "172.16.230.190";// 地址
	public static final String XMPP_HOST = "api.ezendai.com";// 地址
	public static final String XMPP_PORT = "5222";// 端口
	 ...
	 * 精确到毫秒
	 */
	public static final String TIME_FORMART = "yyyy-MM-dd HH:mm:ss SSS";

	/**
	 * 聊天界面现在是否正在运行
	 */
	public static boolean CHATINGRUN = false;
	/**
	 * 聊天界面正在聊天的对象jid
	 */
	 ...
	 * 重连接
	 */
	public static final String ACTION_RECONNECT = "action.xmpp.reconnect";
}
